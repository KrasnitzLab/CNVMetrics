...
![Figure 1. Copy number profiles of two mouse metastatic pancreatic organoids (M10 and M30).]( CNV_mM30_mM10_v03_Feb_08_2021.jpeg "Copy number profile"){ width=100% }
...
----------------------- | ---------------------------------------------
 ...
 Metric Calculation     | `calculateOverlapRegionsMetric(...)`   
 Visualization          | `TODO`
...
![Figure 2. Example of a copy number file containing CNV calls.](Input_CNfile_2.jpg  "Example of a copy number file containing CNV calls."){ width=95% }
