...
This survey represents various similarity measures that are implemented in 
`r Githubpkg("adeschen/CNVMetrics")` package.

## Sørensen


The Sørensen coefficient [@Sorensen48] is calculated by dividing the 
size of the intersection by the smaller of the size of the two sets:
